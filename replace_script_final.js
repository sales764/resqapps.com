...
function processTranslations(path) {
    ...
    content = content.replace(
        /(feature2_title:\s*"First Aid Assistant",[\s\n]*feature2_desc:\s*")[^"]+("\,[\s\n]*feature2_item1:\s*"[^"]+",[\s\n]*feature2_item2:\s*"[^"]+",[\s\n]*feature2_item3:\s*")[^"]+("\,[\s\n]*feature2_item4:\s*")[^"]+(")/g,
    ...
    // 2. FRENCH (Assistant Premiers Secours IA / Assistant Premiers Secours IA)
    content = content.replace(
        /(feature2_title:\s*"(?:Assistant Premiers Secours IA|Assistant Premiers Secours IA)",[\s\n]*feature2_desc:\s*")[^"]+("\,[\s\n]*feature2_item1:\s*"[^"]+",[\s\n]*feature2_item2:\s*"[^"]+",[\s\n]*feature2_item3:\s*")[^"]+("\,[\s\n]*feature2_item4:\s*")[^"]+(")/g,
    ...
    // 3. THAI
    content = content.replace(
        /(feature2_title:\s*"ผู้ช่วยปฐมพยาบาล AI",[\s\n]*feature2_desc:\s*")[^"]+("\,[\s\n]*feature2_item1:\s*"[^"]+",[\s\n]*feature2_item2:\s*"[^"]+",[\s\n]*feature2_item3:\s*")[^"]+("\,[\s\n]*feature2_item4:\s*")[^"]+(")/g,
    ...
    // 4. SPANISH
    content = content.replace(
        /(feature2_title:\s*"Asistente de Primeros Auxilios IA",[\s\n]*feature2_desc:\s*")[^"]+("\,[\s\n]*feature2_item1:\s*"[^"]+",[\s\n]*feature2_item2:\s*"[^"]+",[\s\n]*feature2_item3:\s*")[^"]+("\,[\s\n]*feature2_item4:\s*")[^"]+(")/g,
    ...
    // 5. ITALIAN
    content = content.replace(
        /(feature2_title:\s*"Assistente di Primo Soccorso IA",[\s\n]*feature2_desc:\s*")[^"]+("\,[\s\n]*feature2_item1:\s*"[^"]+",[\s\n]*feature2_item2:\s*"[^"]+",[\s\n]*feature2_item3:\s*")[^"]+("\,[\s\n]*feature2_item4:\s*")[^"]+(")/g,
    ...
    // 6. FILIPINO
    // Need to handle Filipino which also has "First Aid Assistant" as title.
