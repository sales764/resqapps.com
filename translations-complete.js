...
const i18nComplete = {
    en: {
        ...
        privacy_intro_principle1: "Emergency profile information is <strong>ENCRYPTED</strong> on your device and securely backed up to your private account, so only you can access it — and it survives a lost, broken, or replaced phone. Connected features may process operational data for sign-in, alerts, notifications, media attachments, and AI responses.",
        ...
        privacy_local_default_title: "2. Your Emergency Profile — Encrypted and Backed Up",
        privacy_local_default_text: "RESQ+ stores your core emergency profile encrypted on your device (AES-256) and keeps a secure copy in your private account so it is never lost. Only your authenticated account can read it. This data can include:",
    ...
    fr: {
        ...
        privacy_intro_principle1: "Les informations du profil d'urgence sont <strong>chiffrées</strong> sur votre appareil et sauvegardées de façon sécurisée dans votre compte privé — vous seul pouvez y accéder, et votre profil survit à un téléphone perdu, cassé ou remplacé. Les fonctionnalités connectées peuvent traiter des données opérationnelles pour la connexion, les alertes, les notifications, les pièces jointes et les réponses IA.",
        privacy_intro_subtitle2: "⚠️ Important:",
        ...
        privacy_local_default_title: "2. Votre profil d'urgence — chiffré et sauvegardé",
        privacy_local_default_text: "RESQ+ stocke votre profil d'urgence chiffré sur votre appareil (AES-256) et en conserve une copie sécurisée dans votre compte privé pour ne jamais le perdre. Seul votre compte authentifié peut le lire. Ces données peuvent inclure:",
    ...
    th: {
        ...
        privacy_intro_principle1: "ข้อมูลโปรไฟล์ฉุกเฉินถูก<strong>เข้ารหัส</strong>บนอุปกรณ์ของคุณและสำรองข้อมูลอย่างปลอดภัยไปยังบัญชีส่วนตัวของคุณ มีเพียงคุณเท่านั้นที่เข้าถึงได้ และโปรไฟล์ของคุณจะไม่สูญหายแม้โทรศัพท์หาย เสีย หรือเปลี่ยนเครื่องใหม่ ฟีเจอร์ที่เชื่อมต่ออาจประมวลผลข้อมูลการทำงานสำหรับการลงชื่อเข้าใช้ การแจ้งเตือน ไฟล์แนบสื่อ และคำตอบจาก AI",
        ...
        privacy_local_default_title: "2. โปรไฟล์ฉุกเฉินของคุณ — เข้ารหัสและสำรองข้อมูลแล้ว",
        privacy_local_default_text: "RESQ+ เก็บโปรไฟล์ฉุกเฉินของคุณแบบเข้ารหัสบนอุปกรณ์ (AES-256) และเก็บสำเนาที่ปลอดภัยไว้ในบัญชีส่วนตัวของคุณเพื่อไม่ให้สูญหาย มีเพียงบัญชีที่ยืนยันตัวตนของคุณเท่านั้นที่อ่านได้ ข้อมูลนี้อาจรวมถึง:",
